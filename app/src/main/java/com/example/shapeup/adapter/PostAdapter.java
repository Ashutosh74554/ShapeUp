package com.example.shapeup.adapter;
...
import com.example.shapeup.CommentsActivity;
import com.example.shapeup.R;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public class PostViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView postDate, postCaption, postLikes, postUsername;
        ...
        public PostViewHolder(@NonNull View itemView) {
            ...
            commentsPic=mView.findViewById(R.id.comment_button);
            deleteBtn=mView.findViewById(R.id.delete_button);
        }
        public void setPostLikes(int count){
            postLikes=mView.findViewById(R.id.likes_count);
            if(count==1)
